...
<div class="container">
    <div class="jumbotron">
        ...
        <center>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <a class="btn btn-info" id="proximo" onclick="carrega_pagina()" ><span class="glyphicon glyphicon-forward"></span></a>
                    ...
                    <form action="{{route('resultatividades.update', ['id'=> $idresult, 'id_dep'=> $dependente->id])}}" method="post">
                        ...
                        <button type="submit" id="voltar" class="btn btn-info">Sair</button>
                    </form>
                </div>
            </div>
