      ...
      <h1> Meus Dependentes</h1>
        ...
        <div class="table-rolagem">
          <table class="table table-hover table-responsive" id="tabela">
              ...
              <tbody>
                @forelse($resultAtividade as $resultados)
                  ...
                  <tr>
                    ...
                    {{--<td>{{$dependente_['name']}}</td>--}}
                     ...
                     <td><a href="/atividades/index/{{ $dependente_->id }}"><button class="checkthis" data-title="Edit" data-toggle="modal" data-target="#edit" >{{ $dependente_->id }}</button></a></td>
                  </tr>
                @empty
                    <script>
